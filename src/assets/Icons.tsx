...
const Logo: React.FC = () => {
  return (
    <svg className="logo" xmlns="http://www.w3.org/2000/svg" width="170" height="16">
      <title>Logo</title>
      <defs>
...
const Facebook: React.FC = () => {
  return (
    <svg className="facebook-icon" xmlns="http://www.w3.org/2000/svg" width="20" height="20">
...
const Twitter: React.FC = () => {
  return (
    <svg className="twitter-icon" xmlns="http://www.w3.org/2000/svg" width="21" height="18">
...
const Youtube: React.FC = () => {
  return (
    <svg className="youtube-icon" xmlns="http://www.w3.org/2000/svg" width="21" height="20">
...
const Pinterest: React.FC = () => {
  return (
    <svg className="pinterest-icon" xmlns="http://www.w3.org/2000/svg" width="20" height="20">
...
const Instagram: React.FC = () => {
  return (
    <svg className="instagram-icon" xmlns="http://www.w3.org/2000/svg" width="21" height="20">
...
export { Arrow, Logo, Facebook, Twitter, Youtube, Pinterest, Instagram };
